 ...
 * UnixCacioSurfaceManagerFactory and WindowsCacioSurfaceManagerFactory.
 * The actually used CacioSurfaceManagerFactory is set by the respective platform
 * GraphicsEnvironment implementations in the static initializer.
 */
public abstract class CacioSurfaceManagerFactory {

    /**
     * The single shared instance.
     */
    private static CacioSurfaceManagerFactory instance;

    /**
     * Returns the surface manager factory instance. This returns a factory
     * that has been set by {@link #setInstance(CacioSurfaceManagerFactory)}.
     *
     * @return the surface manager factory
     */
    public static synchronized CacioSurfaceManagerFactory getInstance() {

        if (instance == null) {
            throw new IllegalStateException("No CacioSurfaceManagerFactory set.");
        }
        return instance;
    }
     ...
     */
    public static synchronized void setInstance(CacioSurfaceManagerFactory factory) {
